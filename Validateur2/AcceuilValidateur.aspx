<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AcceuilValidateur.aspx.cs" Inherits="AcceuilValidateur" %>
    ...
    <div class="container-fluid">
		<div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li class="active"><a href="AcceuilValidateur.aspx">Acceuil<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
