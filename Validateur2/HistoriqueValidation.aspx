<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HistoriqueValidation.aspx.cs" Inherits="Validateur_HistoriqueValidation" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Historique| Validation</title>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="container-fluid">
		<div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
			<ul class="nav navbar-nav">
				<li><a href="AcceuilValidateur.aspx">Acceuil<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
                <li ><a href="CréerBMM.aspx">Créer BMM<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-list-alt"></span></a></li>
                             <li class="dropdown">
					<a href="AcceuilValidateur.aspx" class="dropdown-toggle" data-toggle="dropdown">Historique<span class="caret"></span><span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-th-list"></span></a>
   ...
   <div class="col-md-8 column">          
      <h2>Historique de validation</h2> <br/>
