<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ValiderBMM.aspx.cs" Inherits="ValiderBMM" %>
...
<% } %>
          ...
          <asp:DropDownList ID="DropDownList1" runat="server"></asp:DropDownList>
                    <asp:Button ID="myButton" runat="server" Text="Valider" OnClick="myButton_Click" />
</div>
