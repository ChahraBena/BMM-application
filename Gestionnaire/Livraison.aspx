<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Livraison.aspx.cs" Inherits="Gestionnaire_Livraison" %>
...
<% } %>
          ...
          <asp:DropDownList ID="DropDownList1" runat="server"></asp:DropDownList>
                    ...
                    <asp:Button ID="LivrerButton" runat="server"  class="btn btn-primary"  Text="Livrer" OnClick="LivrerButton_Click1" Enabled="false" />
